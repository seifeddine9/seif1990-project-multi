...
class home extends CI_Controller {
    ...
    public function appointments($appointment_hash = '') {
        ...
        $view['company_name'] = $this->settings_model->get_setting('company_name');
        $view['date_format'] = $this->settings_model->get_setting('date_format');
        $view['available_services'] = $this->services_model->get_available_services_customer();
        $view['customer_data'] = $this->customers_model->get_row($this->session->userdata('user_id'));
        $view['role_slug'] = $this->session->userdata('role_slug');

        $available_providers = $this->providers_model->get_available_providers_customers();
    ...
    private function get_provider_available_time_periods($provider_id, $selected_date, $exclude_appointments = array()) {
        ...
        $this->load->model('providers_model');
        $this->load->model('settings_model');
        $id_tenant = $this->providers_model->get_tenant($provider_id);
    ...
    public function ajax_get_tenants($key = '') {
        ...
        try {
            ...
            $tenants['tenants'] = $this->user_model->get_tenants($key);
//            
