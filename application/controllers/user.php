...
class User extends CI_Controller {
    ...
    public function our_tenant($tenant_key = '') {
        ...
        $view['tenants'] = $this->user_model->get_tenants($tenant_key);
        $view['base_url'] = $this->config->item('base_url');
        $view['company_name'] = $this->settings_model->get_setting('company_name');
        $view['date_format'] = $this->settings_model->get_setting('date_format');
        $user_id = $this->session->userdata('user_id');
        ...
        $this->load->view('user/header', $view);
        $this->load->view('user/our_tenant', $view);
        $this->load->view('user/footer', $view);
    }
    ...
    public function tenant_profile($id_tenant = '') {
        ...
        try {
            ...
            if ($user_id == TRUE) {
                $view['role_slug'] = $this->session->userdata('role_slug');
                $view['customer_data'] = $this->customers_model->get_row($this->session->userdata('user_id'));
                $view['customer_data']['user_id'] = $this->session->userdata('user_id');
                $view['user_id'] = $this->session->userdata('user_id');
            } else {
        ...
        $this->load->view('user/header', $view);
        $this->load->view('user/tenant_profile', $view);
        $this->load->view('user/footer', $view);
    }
    ...
    public function new_tenant() {
        ...
        $this->load->view('user/header', $view);
        $this->load->view('user/new_tenant_test', $view);
        $this->load->view('user/footer', $view);
    }
