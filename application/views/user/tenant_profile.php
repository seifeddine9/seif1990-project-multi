...
<link
    rel="stylesheet"
    type="text/css"
    href="<?php echo $this->config->item('base_url'); ?>assets/ext/themeforest/style.css">

<!--<link
    rel="stylesheet"
    type="text/css"
    href="<?php echo $this->config->item('base_url'); ?>assets/ext/themeforest/style-responsive.css" rel="stylesheet" />-->
...
<script
    type="text/javascript"
src="<?php echo $this->config->item('base_url'); ?>assets/js/frontend_profile_tenant.js"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        FrontendTenantProfile.initialize(true, GlobalVariables.manageMode);
...
<div class="content-page">
    ...
    <div class="profile-banner" style="background-image: url(<?php echo $this->config->item('base_url'); ?>assets/img/background.jpg);">
        <div class="col-sm-3 avatar-container">
            <img src="<?php echo $this->config->item('base_url'); ?>assets/img/muhammad.jpg" class="img-circle profile-avatar" alt="User avatar">
        </div>
        <div class="col-sm-12 profile-actions text-right">
            
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#book-modal"><i class="fa fa-calendar"></i> Prendre un rendez-vous</button>
            ...
            <div class="col-sm-9">
                <div class="widget widget-tabbed">
                    ...
                    <ul class="nav nav-tabs nav-justified">
                        <li class="active"><a href="#about" data-toggle="tab"><i class="fa fa-user"></i> Information générale</a></li>
                        <li ><a href="#my-timeline" data-toggle="tab"><i class="fa fa-map"></i> Map</a></li>                          
                    ...
                    <div class="tab-content">
                        ...
                        <!-- Tab timeline -->
                        <div class="tab-pane animated" id="my-timeline">
                            <div class="user-profile-content">
                                <div class="row">
                                    <div class="col-md-12 portlets">
                                        <div class="widget">
                                            <div id="gmap-1" style="height:550px;width: 950px;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <h3 class="modal-title frame-title" style="text-align: center;  color: #fff;">Prendre un rendez-vous</h3>
            ...
            <div id="book-appointment-wizard" class="">
                ...
                <div id="wizard-frame-2" class="wizard-frame" >
                    ...
                    <div class="frame-container hidden  www ">
                    ...
                    <div class="command-buttons">
                          <button class="waiting-appointment btn btn-primary" id="waiting-appointment" 
                                    type="button" > Demander un rendez-vous&nbsp;&nbsp;<span class="glyphicon glyphicon-plus"></span></button>
...
<script
    type="text/javascript"
src="<?php echo $this->config->item('base_url'); ?>assets/ext/themeforest/google-maps.js"></script>