...
class Appointments_Model extends CI_Model {
     ...
     * */
    public function get_count_filter($date_debut, $date_fin,$id_tenant) {
     ...
     * get appointment number
     * */
    public function get_count_price($id_tenant) {
        $num_rows = $this->db
     ...
     * get filtred appointment number
     * */
    public function get_count_filter_price($date_debut, $date_fin,$id_tenant) {
     ...
     * */
    public function get_count_confirmed_filter($date_debut, $date_fin,$id_tenant) {
     ...
     * */
    public function get_count_confirmed($id_tenant) {
        $date = date('Y-m-d H:i:s');
        $num_rows = $this->db
                        ->select_sum('ea_services.price', 'total')
                        ->from('ea_appointments')
     ...
     * */
    public function get_count_projected($id_tenant) {
        $date = date('Y-m-d H:i:s');
        $num_rows = $this->db
                        ->select_sum('ea_services.price', 'total')
                        ->from('ea_appointments')
     ...
     * @return array Returns the rows from the database.
     */
    public function get_batch_filter($date_debut, $date_fin, $id_tenant) {

        $this->db->order_by('start_datetime', 'desc');
        $this->db->where('ea_appointments.start_datetime <', $date_fin);
        $this->db->where('ea_appointments.start_datetime >', $date_debut);
		$this->db->where('ea_appointments.id_tenant', $id_tenant);
        return $this->db->get('ea_appointments')->result_array();
    }
